...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    TextEditingController phoneNumberController = TextEditingController(text: '123-456-7890');
            ...
            children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child:const Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Icon(Icons.female, size: 32, color: Colors.pinkAccent),
                            SizedBox(width: 8),
                            Text(
                              'Female',
                              style: TextStyle(
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: '123-456-7890', // Example format
                    labelStyle: const TextStyle(
                      color: Colors.grey,
                      fontSize: 16,
                    ),
             ...
             const Padding (
              ...
              Container(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(16.0), // Add padding within the container
                  child: TextField(
